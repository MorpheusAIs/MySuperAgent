...
class LineGenerator(Visitor[Line]):
    ...
    def visit_suite(self, node: Node) -> Iterator[Line]:
        """Visit a suite."""
        if (self.mode.is_pyi or Preview.dummy_implementations in self.mode) and is_stub_suite(node, self.mode):
...
def _maybe_split_omitting_optional_parens(
    ...
    if (
        ...
        try:
            ...
            prefer_splitting_rhs_mode = Preview.prefer_splitting_right_hand_side_of_assignments in line.mode
