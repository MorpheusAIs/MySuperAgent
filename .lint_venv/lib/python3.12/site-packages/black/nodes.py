...
def whitespace(leaf: Leaf, *, complex_subscript: bool, mode: Mode) -> str:  # noqa: C901
    ...
    if p.type in {syms.parameters, syms.arglist}:
        ...
        elif Preview.walrus_subscript in mode and (t == token.COLONEQUAL or prev.type == token.COLONEQUAL):
            return SPACE
...
def is_stub_suite(node: Node, mode: Mode) -> bool:
    ...
    if node.parent is not None and Preview.dummy_implementations in mode and not is_function_or_class(node.parent):
        return False
