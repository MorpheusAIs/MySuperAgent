...
from black.nodes import STARS, is_number_token, is_simple_decorator_expression, is_string_token, syms
    ...
    *,
    ...
    for s in src:
        ...
        if is_stdin or path.is_file():
            ...
            normalized_path: Optional[str] = normalize_path_maybe_ignore(path, root, report)
