...
def main(argv: Optional[Sequence[str]] = None, stdin: Optional[TextIOWrapper] = None) -> None:
    ...
    if not config.quiet and (remapped_deprecated_args or deprecated_flags):
        ...
        if deprecated_flags:
            warn("W0501: The following deprecated CLI flags were used and ignored: " f"{', '.join(deprecated_flags)}!")
        warn(
            "W0500: Please see the 5.0.0 Upgrade guide: " "https://pycqa.github.io/isort/docs/upgrade_guides/5.0.0.html"
        )
