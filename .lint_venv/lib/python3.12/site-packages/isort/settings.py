    ...
    def __post_init__(self) -> None:
        ...
        if py_version == "auto":  # pragma: no cover
            if sys.version_info.major == 2 and sys.version_info.minor <= 6:
                py_version = "2"
            elif sys.version_info.major == 3 and (sys.version_info.minor <= 5 or sys.version_info.minor >= 12):
                py_version = "3"
            else:
            ...
            if section.startswith("*.{") and section.endswith("}"):
                ...
                for config_key in config.keys():
                    if (
                        ...
                        and extension
                        in map(lambda text: text.strip(), config_key[len("*.{") : -1].split(","))  # type: ignore # noqa
                    ):
