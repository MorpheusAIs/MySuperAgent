...
async def extract_final_answer_actions(
    chat_prompt: str, final_answer: str, standard_model: str, efficient_model: str, standard_model_api_key: str
    ...
    try:
        ...
        for detected_action in action_plan.actions:
            ...
            if action_type == FinalAnswerActionType.TWEET:
                ...
                tweet_metadata = TweetActionMetadata(
                    agent="tweet_sizzler",
                ...
                swap_metadata = SwapActionMetadata(
                    agent="token_swap",
                    action_id=str(uuid.uuid4()),
                    timestamp=timestamp,
                ...
                transfer_metadata = TransferActionMetadata(
                    agent="token_swap",
                    action_id=str(uuid.uuid4()),
                    timestamp=timestamp,
                ...
                imagen_metadata = ImageGenerationActionMetadata(
                    agent="imagen",
                    action_id=str(uuid.uuid4()),
                    timestamp=timestamp,
